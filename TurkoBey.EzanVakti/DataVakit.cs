...
namespace TurkoBey.EzanVakti
{
    public class DataVakit
    {
        ...
        public string KibleZamani { get; set; }
        public string AstronomikGunesDogus { get; set; }
        public string AstronomikGunesBatis { get; set; }
    }
}
